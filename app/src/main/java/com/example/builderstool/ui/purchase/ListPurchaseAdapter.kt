...
import kotlinx.android.synthetic.main.card_puchases.view.*
import kotlinx.android.synthetic.main.card_puchases.view.rv_bill
import kotlinx.android.synthetic.main.card_puchases.view.tv_total

class ListPurchaseAdapter(var context: Context,var purchases:ArrayList<Purchase>):RecyclerView.Adapter<ListPurchaseAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(context).inflate(R.layout.card_puchases,parent,false))
    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        var purchase=purchases[position]
        holder.itemView.tv_id.text=purchase.id.toString()
        holder.itemView.tv_supplier.text=purchase.supplierName.toString()
        ...
        holder.itemView.rv_bill.layoutManager=LinearLayoutManager(context,LinearLayoutManager.VERTICAL,false)
        ...
        holder.itemView.btn_bill.setOnClickListener {
            ...
            PdfUtils().createPurchaseBill(context,purchase)
        }
    }
